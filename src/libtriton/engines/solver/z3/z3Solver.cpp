...
namespace triton::engines::solver 
{
  ...
  std::vector<std::unordered_map<triton::usize, SolverModel>> Z3Solver::getModels(
  ...
  std::unordered_map<triton::usize, SolverModel> Z3Solver::getModel(
    const triton::ast::SharedAbstractNode& node, 
    triton::engines::solver::status_e* status, 
    triton::uint32 timeout, triton::uint32 *solvingTime) const 
  {
